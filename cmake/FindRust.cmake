...
if (NOT Rust_CARGO_TARGET_CACHED)
    ...
    if (Apple)
        if (CMAKE_OSX_ARCHITECTURES MATCHES "arm64" AND CMAKE_OSX_ARCHITECTURES MATCHES "x86_64")
                message(FATAL_ERROR "Compiling universal binaries on Apple platforms is not supported.")
        endif()
        if (CMAKE_SYSTEM_PROCESSOR MATCHES "^(AMD64|amd64|x86_64)$" OR CMAKE_OSX_ARCHITECTURES STREQUAL "x86_64")
                set(_CARGO_ARCH x86_64)
                set(Rust_CARGO_TARGET_CACHED "x86_64-apple-darwin" CACHE STRING "Target triple")
        elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "^(ARM64|arm64|aarch64)$" OR CMAKE_OSX_ARCHITECTURES STREQUAL "arm64")
                set(_CARGO_ARCH aarch64)
                set(Rust_CARGO_TARGET_CACHED "aarch64-apple-darwin" CACHE STRING "Target triple")
        else()
                message(WARNING "Unknown CMAKE_SYSTEM_PROCESSOR for Apple: ${CMAKE_SYSTEM_PROCESSOR}")
        endif()
    elseif (WIN32)
